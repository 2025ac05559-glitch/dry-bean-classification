...
| :--- | :--- |
| **Logistic Regression** | **Overall Winner.** Highest Accuracy (0.9214) and AUC (0.9948) of all 6 models, after feature scaling, since bean shape features separate the 7 classes fairly linearly. |
...
| **Gradient Boosting (Ensemble)** | Best Precision (0.9360), Recall (0.9309), F1 (0.9333), and MCC (0.9040) via sequential boosting, though slightly behind Logistic Regression on Accuracy/AUC. |
| **Overall Winner for this dataset** | **Logistic Regression** — highest Accuracy and AUC of all 6 models; Gradient Boosting is a close runner-up, leading on Precision/Recall/F1/MCC. |